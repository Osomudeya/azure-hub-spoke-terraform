...
output "peering_status" {
  ...
  value = {
    hub_to_spoke1_status = module.hub_spoke1_peering.hub_to_spoke_peering_status
    spoke1_to_hub_status = module.hub_spoke1_peering.spoke_to_hub_peering_status
    hub_to_spoke2_status = module.hub_spoke2_peering.hub_to_spoke_peering_status
    spoke2_to_hub_status = module.hub_spoke2_peering.spoke_to_hub_peering_status
  }
}
